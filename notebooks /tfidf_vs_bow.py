...
CONFIG = {
    ...
    "test_size" : 0.2,
    "mlflow_tracking_uri":"https://dagshub.com/arpitgupta09/main-Project.mlflow",
    "dagshub_repo_owner": "arpitgupta09",
...
def train_and_evaluate(df):
    with mlflow.start_run(run_name = "All Expermients") as parent_run:
        for algo_run , algorithm in ALGORITHMS.items():
            for vec_name , vectorizer in VECTORIZER.items():
                with mlflow.start_run(run_name = f"{algo_name} with {vec_name}",nested = True) as child_run:
                    try:
                        ...
                        # check whether the inout is sparse or not -> important for this type of data 
                        ...
                        print("error in training {algo_name} with {vec_name} : {e}")
                        raise
